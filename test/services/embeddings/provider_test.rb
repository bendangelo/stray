...
class Embeddings::ProviderTest < ActiveSupport::TestCase
  setup do
  ...
  test "resolve returns LocalMiniLM for NONE" do
    ...
    assert_instance_of Embeddings::Providers::LocalMiniLM,
                       Embeddings::Provider.resolve
  end
  ...
  test "resolve returns OpenAICompatible for OPENAI_COMPATIBLE" do
    ...
    assert_instance_of Embeddings::Providers::OpenAICompatible,
                       Embeddings::Provider.resolve
  end
